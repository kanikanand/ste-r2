...
/*
 * Soft ceiling. A hard clamp pins the top of a form at exactly 1 across a broad
 * area, and a flat top displaces every row it covers by the same amount — those
 * rows keep their spacing and read as a solid slab, with a hard edge where the
 * plateau stops. This is the identity below 0.6 and eases onto 1 above it, so a
